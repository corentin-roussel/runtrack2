...
$sql = ("SELECT * FROM etudiants WHERE TIMESTAMPDIFF(YEAR, naissance, CURDATE()) <= 18;"); // Stocké dans une variable selectionné  tous les champ pour etudiants en dessous de 18ans
