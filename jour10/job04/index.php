...
$sql = ("SELECT * FROM etudiants  where LEFT(prenom, 1) = 'T';"); // Stocké dans une variable selectionné  tous les champ pour etudiants ou index de gauche a 1 et égale a 'T'
