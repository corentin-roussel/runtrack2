...
$sql = ("SELECT prenom, nom, naissance FROM etudiants WHERE naissance BETWEEN '1998-01-01' AND '2018-01-01';"); // Stocké dans une variable selectionné  tous les champ pour etudiants en dessous de 18ans
