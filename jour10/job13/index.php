...
$sql = ("SELECT etage.nom AS nom_etages, salles.nom AS 'nom_salles' FROM salles INNER JOIN etage ON salles.id_etage=etage.id"); // Stocké dans une variable selectionné  tous les champ pour etudiants en dessous de 18ans
